...
module.exports = function() {
    ...
    var Row  = Class({
        ...
        update: function(conn, dto, cb) {
            ...
            //MODIFICADO POR WALICHIN: NO ACTUALIZA LA COLUMNA "version" Y TAMPOCO VERIFICA LA VERSION ANTERIOR DEL REGISTRO
        ...
        _update: function(conn, dto, conditions, cb) {
            ...
            //MODIFICADO POR WALICHIN: NO ACTUALIZA LA COLUMNA "last_updated"
